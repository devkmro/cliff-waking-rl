...
def update_environment(env, agent_pos, action, cliff_pos, goal_pos, rewards_cache, steps_cache, episode, max_steps, current_epsilon, q_table):
    ...
    return agent_pos, env, reward, next_action, next_state, game_over
...
def sarsa(sim_input, sim_output) -> (np.array, list):
    ...
    for episode in range(num_episodes):
        ...
        while not game_over:
            ...
            agent_pos, env, reward, next_action, next_state, game_over = update_environment(
                env, agent_pos, action, cliff_pos, goal_pos, rewards_cache, steps_cache, episode, max_steps, current_epsilon, q_table)
